   ...
   // ObservableList<Commercial> model_commercial = FXCollections.observableArrayList();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try{
            ...
            //repo = new ClientDAO();
            txt_id_comm.getItems().addAll(Api.CommercialsList());
        ...
        try {
            ...
            //try {
                ...
                if (this.checkAllInputs(actionCli)){
                    actionCli.print();
                    //System.out.println("ok insert or update");
                    if (action == "ajouter") {
                    ...
                    message.setText("Certains champs ne sont pas corrects");
                }
...
//        }
    ...
    private boolean checkAllInputs(Client cli) throws MissFormatException{
        ...
        //System.out.println("check start 2");
        ...
        if (!missFormat.isEmpty()){
            //System.out.println("execption levée");
            throw missFormat;
        }
...
//        try {
//            txt_id_comm.setValue(Api.getCommercialById(1));

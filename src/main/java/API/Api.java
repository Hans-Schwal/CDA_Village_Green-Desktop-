...
public class Api {
    ...
    public static List<Client> List() {
        ...
        try {
            String sURL = "https://dev.amorce.org/hans/Village_Green/ci/index.php/api/liste";
    ...
    public static List<Commercial> CommercialsList() {
        ArrayList<Commercial> resultat = new ArrayList<Commercial>();
        //System.out.println("test3");
        try {
            String sURL = "https://dev.amorce.org/hans/Village_Green/ci/index.php/api/CommercialsList";
            ...
            Commercial[] liste = gg.fromJson(root, Commercial[].class);
    ...
    public static void Insert(Client cli) {
        try {
            ...
            String sURL = "https://dev.amorce.org/hans/Village_Green/ci/index.php/api/insert";
            URL api = new URL(sURL);
    ...
    public static void Update(Client cli) {
        try {
            ...
            // Configuration du service web
            String sURL = "https://dev.amorce.org/hans/Village_Green/ci/index.php/api/update";
            URL api = new URL(sURL);
            HttpURLConnection request = (HttpURLConnection) api.openConnection();
            request.setRequestMethod("POST");
            request.setRequestProperty("Content-Type", "application/json; utf-8");
    ...
    public static void Delete(Client cli) {
        try {
            ...
            // Configuration du service web
            String sURL = "https://dev.amorce.org/hans/Village_Green/ci/index.php/api/delete";
            URL api = new URL(sURL);
            HttpURLConnection request = (HttpURLConnection) api.openConnection();
            request.setRequestMethod("POST");
            request.setRequestProperty("Content-Type", "application/json; utf-8");
    ...
    public static void DetailProduit(Produit Pro) {
        try {
            String sURL = "http://127.0.0.1:8080/index.php/api/detailProduit" + Pro.getId_produit();
